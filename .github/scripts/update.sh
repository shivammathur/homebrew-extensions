...
version=$2
case $extension in
  amqp|apcu|ast|couchbase|ds|expect|event|gnupg|grpc|imagick|msgpack|protobuf|propro|psr|raphf|rdkafka|redis|mailparse|memcached|mcrypt|mongodb|ssh2|sqlsrv|pdo_sqlsrv|vips|xlswriter|yaml)
