...
version=$2
case $extension in
  amqp|apcu|couchbase|expect|gnupg|grpc|imagick|msgpack|protobuf|propro|psr|raphf|rdkafka|redis|mailparse|memcached|mcrypt|mongodb|ssh2|vips|xlswriter|yaml)
