...
class LuaAT73 < AbstractPhpExtension
  ...
  bottle do
    ...
    rebuild 1
    sha256 cellar: :any,                 arm64_golden_gate: "537dedf17307618d129c34657bdc64d63b1a1b0b9f0f1d1a601d24b6c52b0b9c"
    ...
    sha256 cellar: :any,                 sonoma:            "a9e68a272cfd6e21336341fab2d29f469c971a185139b5542700e045ec664a50"
    ...
    sha256 cellar: :any,                 x86_64_catalina:   "285803444e907676e9f88e8b7648221d71ec69a50717d2530abda160477fb164"
  end
