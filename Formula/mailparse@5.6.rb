...
class MailparseAT56 < AbstractPhpExtension
  ...
  bottle do
    ...
    rebuild 1
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "80cb58255dfc563c64e0e97ebbb6ac8188ebaf920a1679d4db278d9a338306f6"
    ...
    sha256 cellar: :any_skip_relocation, sonoma:            "3fda0409fc26424aa00c6dbcf074eea408df9313e2b051e2136c35e75b94d069"
    ...
    sha256 cellar: :any_skip_relocation, x86_64_catalina:   "1f3d1ef9cdb318ea53c9334e285771d3eb594472a938fa95dd51b0d1e5f74ec2"
  end
