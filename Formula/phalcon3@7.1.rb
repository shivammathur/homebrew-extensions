...
class Phalcon3AT71 < AbstractPhpExtension
  ...
  head "https://github.com/phalcon/cphalcon.git", branch: "3.4.x"
  license "BSD-3-Clause"

  bottle do
    root_url "https://ghcr.io/v2/shivammathur/extensions"
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "2594096a33ed84d42c7f254094a3ee2f39b8b01c9594547c1b55b1bf92e3000d"
    ...
    sha256 cellar: :any_skip_relocation, sonoma:            "b5cb55a26b373f2af5226eb11fa0c0abe38eb400d0f36db2df055601b0aef182"
    ...
    sha256 cellar: :any_skip_relocation, arm64_linux:       "68d92df565c52763c18d0a0eadc7e13bf75039a02e950f35ed8e63aa4a13c39b"
    sha256 cellar: :any_skip_relocation, x86_64_linux:      "e036b6371cdd8699dd2055965861f91d62557664609efa8c0d92ef69dbfef97b"
    sha256 cellar: :any_skip_relocation, x86_64_catalina:   "95ba6a141cee048cad040562a79b2b41b08a393f2d525884639dbf9c4bd03c60"
  end
