...
class MemcachedAT73 < AbstractPhpExtension
  ...
  bottle do
    ...
    sha256 cellar: :any,                 arm64_golden_gate: "8bc3102b7e2f37c02e3095f9da8ee950687ee44e9f108b1598c6c97658d0ccd9"
    ...
    sha256 cellar: :any,                 sonoma:            "ba28cd2b10c82ef47004cd1d0cd72f16302f14c65abcd0b63dfbe2a45da8df76"
  ...
  def patch_memcached
    %w[igbinary msgpack].each do |e|
      ...
      headers = Dir["#{Utils::Path.formula_opt_include("#{e}@7.3")}/**/*.h"]
