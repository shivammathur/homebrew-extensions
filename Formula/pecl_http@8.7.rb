...
class PeclHttpAT87 < AbstractPhpExtension
  init
  ...
  depends_on "shivammathur/extensions/raphf@8.7"
  depends_on "zlib"
  ...
  def install
    ...
    extra_includes = %W[
      -I#{Utils::Path.formula_opt_include("shivammathur/extensions/raphf@8.7")}/php
    ]
    ...
    inreplace "src/php_http_api.h", "ext/raphf", "ext/raphf@8.7"
