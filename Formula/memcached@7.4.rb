...
class MemcachedAT74 < AbstractPhpExtension
  ...
  bottle do
    ...
    sha256 cellar: :any,                 arm64_golden_gate: "435566d99f49df41965093aea722e033103e124281010f00bca29c148c75a061"
  ...
  def patch_memcached
    %w[igbinary msgpack].each do |e|
      ...
      headers = Dir["#{Utils::Path.formula_opt_include("#{e}@7.4")}/**/*.h"]
