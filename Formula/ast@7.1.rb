...
class AstAT71 < AbstractPhpExtension
  ...
  bottle do
    ...
    rebuild 1
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "b5fea42a713d7fb4bdc8b236b23975b68d6639f926ff05f2b0802826967d9949"
    ...
    sha256 cellar: :any_skip_relocation, sonoma:            "676b7600edf2ad810ad73909503231c4e74f73a943ad64003ee3019dfb55d5b7"
    ...
    sha256 cellar: :any_skip_relocation, x86_64_catalina:   "4d42af8e5acfe0c298460e97f40ad4c74f7cd79097a433ca18da81f6beb30ba1"
  end
