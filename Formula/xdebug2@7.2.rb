...
class Xdebug2AT72 < AbstractPhpExtension
  ...
  bottle do
    ...
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "443f2ce6bd3c0d31231e2e2c707d40d6e64cedc2790e470aec7ed9aa4ed88cf7"
    ...
    sha256 cellar: :any_skip_relocation, x86_64_catalina:   "be532f6cf3d6037d28a6cc03154fc673920f1df41d559eb19ab69c67fe05dece"
  end
