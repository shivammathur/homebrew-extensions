...
class ExpectAT84 < AbstractPhpExtension
  ...
  bottle do
    ...
    rebuild 5
    sha256 cellar: :any,                 arm64_golden_gate: "20cd6c89318fda15d1fbac2cf012e1bcf828bd805ed836f17a21982f4af9366f"
    ...
    sha256 cellar: :any,                 sonoma:            "56364736550151709c5a9e57a93ad572c53da3efe9d1d03d4a9a5cc8a75c5dd6"
    sha256 cellar: :any,                 ventura:           "a64991e7330d6e546dc46effeaa42cdf9cd0d86208b79fbc6abd717c2e76db0d"
    sha256 cellar: :any_skip_relocation, arm64_linux:       "feef3de90c9023d27a3b85992efa4e0e98ccba3713566b2be4985893e14d9eed"
