...
class MemcachedAT71 < AbstractPhpExtension
  ...
  bottle do
    ...
    sha256 cellar: :any,                 arm64_golden_gate: "a3c911bfdb715b8593525d9fcec741b76e5b1ad5a9e812f5dd2a7e25726ea337"
    ...
    sha256 cellar: :any,                 sonoma:            "1a373c9117816077cfd28e54282c3c2200ad5bc19069ec2e5474e70f76bf08cf"
  ...
  def patch_memcached
    %w[igbinary msgpack].each do |e|
      ...
      headers = Dir["#{Utils::Path.formula_opt_include("#{e}@7.1")}/**/*.h"]
