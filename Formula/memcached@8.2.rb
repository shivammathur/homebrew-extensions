...
class MemcachedAT82 < AbstractPhpExtension
  ...
  bottle do
    ...
    sha256 cellar: :any,                 arm64_golden_gate: "85d944165845294b6eaa88e88c65af60e64f4d51c628f8a6e10b22c391c5572d"
    ...
    sha256 cellar: :any,                 sonoma:            "f7f733f396e49fa113fec16fb4c9738b2a2bce221b59e8fd9c7fe10965e4c51f"
  ...
  def patch_memcached
    %w[igbinary msgpack].each do |e|
      ...
      headers = Dir["#{Utils::Path.formula_opt_include("#{e}@8.2")}/**/*.h"]
