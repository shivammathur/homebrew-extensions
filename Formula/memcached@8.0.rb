...
class MemcachedAT80 < AbstractPhpExtension
  ...
  bottle do
    ...
    sha256 cellar: :any,                 arm64_golden_gate: "88060989651630514cef82a3b9c04bcccbec35613d91bbb1532451937d9ecf13"
    ...
    sha256 cellar: :any,                 sonoma:            "dad658f027fcc418a1499b52dab60ffc1524211386f4696bcbb663fef98647f4"
  ...
  def patch_memcached
    %w[igbinary msgpack].each do |e|
      ...
      headers = Dir["#{Utils::Path.formula_opt_include("#{e}@8.0")}/**/*.h"]
